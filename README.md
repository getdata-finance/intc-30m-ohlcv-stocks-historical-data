...
> **Sample on GitHub** · `INTC_30m.csv` (1,848 rows, `2026-02-06` -> `2026-09-01`, 189.66 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/intc)** — **21,230** `30m` rows (full `1m`: 635,826), **11 timeframes**, `2020-02-24` -> `2026-09-01`.
